 ...
 */
fun convertNumericQualityToStringOld(quality: Int, resources: Resources): String {
...
fun convertDurationToFormattedOld(startTimeMilli: Long, endTimeMilli: Long, res: Resources): String{
